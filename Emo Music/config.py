...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Emo Helper")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "@Emo_Bot_Support")
PROJECT_NAME = getenv("PROJECT_NAME", "Emo Bot")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/RishBropromax/Emo-Vc-Bot")
